...
<body class="bg-indigo-100 h-screen flex items-center justify-center">
    <div class="container mx-auto p-8 bg-indigo-50 rounded-lg shadow-lg max-w-3xl w-full">
        <h1 class="text-4xl font-bold mb-6 text-center text-indigo-600">Detail Siswa</h1>
        <div class="flex flex-col md:flex-row items-center mb-8">
            ...
            <div class="flex flex-col gap-5 mt-5 justify-center">
                <h2 class="text-3xl font-semibold text-indigo-600">{{ $siswa->name }}</h2>
        ...
        <div class="flex justify-end">
            <a href="{{ route('siswa.index') }}" class="btn btn-primary text-lg text-white">Kembali</a>
        </div>
    </div>
</body>
</html>
