...
<div class="navbar bg-indigo-100 p-5 flex items-center justify-between">
    <h1 class="text-2xl font-bold text-blue-600">DATA SISWA</h1>
...
@if(session('success'))
    <div role="alert" id="confirm-alert" class="alert alert-success rounded-none text-white bg-blue-600">
...
<div class="flex-grow">
    <div class="mt-10 mb-6 flex justify-end mx-20">
        <a href="{{ route('siswa.create') }}" class="btn btn-outline btn-primary text-md px-2 py-3 text-white btn-md">Tambah Siswa</a>
    </div>

    <div class="bg-indigo-50 ml-[100px] mr-[100px] mb-10 rounded-xl shadow-xl p-5">
        ...
        <div class="flex items-center justify-end ml-[100px] mr-[100px]">
            <form action="" id="search-form" method="GET" class="flex items-center w-full max-w-md">
                <input type="text" name="cari" placeholder="Cari..." class="input input-bordered input-primary input-sm w-full">
                <input type="submit" class="btn btn-primary btn-sm ml-2 text-white" value="Cari">
            </form>
        </div>
            ...
            <table class="table w-full">
                ...
                <tbody>
                    @forelse($siswas as $siswa)
                        <tr>
                            ...
                            <td>
                                <form id="delete-form-{{ $siswa->id }}" action="{{ route('siswa.destroy', $siswa->id) }}" method="POST" class="space-x-2">
                                    ...
                                    <a href="{{ route('siswa.edit', $siswa->id) }}" class="btn btn-primary btn-square btn-sm">
                        ...
                        <div class="modal">
                            <div class="modal-box  bg-indigo-50">
