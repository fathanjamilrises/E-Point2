...
<body class="bg-indigo-100 h-screen flex items-center justify-center">
    <div class="container mx-auto p-6 bg-indigo-50 rounded-lg shadow-lg max-w-2xl w-full">
        <h1 class="text-3xl font-bold mb-4 text-center text-blue-600">Edit Siswa</h1>
    ...
    <div id="confirmationModal" class="modal">
        <div class="modal-box bg-indigo-100">
            ...
            <div class="modal-action">
                <button class="btn btn-primary" onclick="confirmEdit()">Ya, Simpan</button>
                <button class="btn btn-neutral" onclick="closeModal()">Batal</button>
            </div>
        </div>
    </div>
